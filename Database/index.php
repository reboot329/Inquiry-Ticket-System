...
?>
    ...
    <br />
    <b style="font-size:15px;color:red">(Email for that account is  dbtest4fey@gmail.com : dbtestforfey)</b>
    <br />
    <b style="font-size:15px;color:red">(Login to Gmail and see the emails as admin)</b>
